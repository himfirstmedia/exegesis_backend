 ...
 *
 * 1. Enrich every existing dailyVerse that is missing rich fields
 *    by matching bookName|chapter|verseNumber against the verseLibrary.
 * 2. Create a fully-populated verse for every day from today through
...
const verseLibrary = [
  {
    ...
    backgroundContext: "This verse follows the Macedonian vision at Troas during Paul's second missionary journey. It marks the gospel's first intentional move into Europe, initiated by divine calling rather than human planning.",
    ...
    practicalApplications: JSON.stringify([
  ...
  },
  {
    ...
    verseIntroduction: "John 3:16 reveals the heart of the gospel: a love that moves God to give, and a faith that opens the door to eternal life. It is both a declaration and an invitation.",
    backgroundAuthor: "The apostle John wrote his Gospel so that his readers might believe that Jesus is the Christ and, by believing, have life in His name (John 20:31).",
    ...
    backgroundContext: "Jesus speaks these words in His conversation with Nicodemus, a teacher of Israel, explaining the necessity of rebirth and God's worldwide plan of salvation.",
    wordStudies: JSON.stringify([
  ...
  },
  {
    ...
    backgroundBook: "Romans unfolds the message of righteousness from God, climaxing in chapters of assurance: nothing can separate us from God's love.",
    backgroundContext: "This promise crowns the Spirit's chapter, contrasting the weakness of the flesh with the purpose of God, who predestined believers to be conformed to Christ.",
    wordStudies: JSON.stringify([
    ...
    keyThemes: JSON.stringify(["Anchored certainty in God", "Sovereign providence", "Divine calling and purpose", "Conformity to Christ as the 'good'", "Love that is the mark of the called"]),
    ...
    finalThoughts: "The certainty of Romans 8:28 is not that every day will feel good, but that every day is being worked toward good. God is never surprised, never late, and never out of control.",
  ...
  },
  {
    ...
    backgroundContext: "This verse opens a series of counsel on trusting God in wealth and daily life; it is the foundation for walking the path of wisdom.",
    wordStudies: JSON.stringify([
  ...
  },
  {
    ...
    backgroundAuthor: "Paul wrote this letter from prison chains, yet it is his most joyful epistle — joy rooted not in circumstances but in Christ.",
    ...
    crossReferences: JSON.stringify(["Philippians 4:12 – I know how to be abased, and I know how to abound.", "2 Corinthians 12:9 – My grace is sufficient; my strength is perfected in weakness.", "Ephesians 3:16 – Strengthened with power through His Spirit.", "Psalm 28:8 – The LORD is the strength of His people."]),
    finalThoughts: "Strength does not come from the absence of difficulty but from the presence of Christ. What He calls you into, He strengthens you for.",
  ...
  },
  {
    ...
    explanation: "This beloved opening verse presents the LORD as the Shepherd who tends His sheep with personal, watchful care. The name 'LORD' (Yahweh) recalls the covenant-keeping God; 'my shepherd' speaks of an intimate relationship; 'I shall not want' expresses complete trust. The verse does not promise the absence of need but the sufficiency of the Shepherd: those who belong to Him lack nothing that is right and good for life. This image finds its fulfillment in Christ, the good Shepherd who lays down His life for the sheep.",
    application: "Bring your anxiety over provision to the Shepherd. Receive all that is needful from His care, and trust the faithfulness of the flock under His hand.",
    ...
    backgroundAuthor: "David — shepherd, warrior, and king — writes from the language of a shepherd's life, drawing the metaphor from his own years of tending sheep.",
    ...
    backgroundContext: "This verse opens the psalm that celebrates the LORD's guidance, provision, and protection across the whole of a believer's journey.",
    wordStudies: JSON.stringify([
    ...
    crossReferences: JSON.stringify(["John 10:11 – The good Shepherd lays down His life for the sheep.", "Psalm 100:3 – The LORD is God; we are His people, the sheep of His pasture.", "Isaiah 40:11 – He gathers the lambs and leads those with young.", "1 Peter 2:25 – Christ is the Shepherd and Overseer of your souls."]),
    finalThoughts: "When the LORD is your Shepherd, there is no lasting want. His care covers every path, so the heart can rest in His sufficient hand.",
  ...
  },
  {
    ...
    explanation: "Jeremiah wrote to the exiles in Babylon who had assumed their hope was over. Against false prophets promising an immediate return, the LORD declares through the prophet that His thoughts toward His people are thoughts of peace — not of evil — and that He has a future and a hope for them. This is not a blanket promise of trouble-free days but a covenant assurance: even within the seventy years of exile, God's plan is one of preservation and restoration. It reframes the present difficulty as a chapter, not the final word, and anchors hope in the faithfulness of God.",
    application: "While you wait through seasons that feel like exile, trust the One with an eternal plan. Your purpose today lies within His hands, and the future He has for you is real.",
    verseIntroduction: "This is not a promise of immediate relief but a promise of a good future to a people God has not abandoned — hope that holds in the heart of exile.",
    ...
    backgroundBook: "The Book of Jeremiah records the prophetic call to repentance and the promise of restoration that follows judgment.",
    backgroundContext: "These words come from a letter to the Jews already deported to Babylon, urging them to settle, pray, and trust God's long-term plan of restoration.",
    wordStudies: JSON.stringify([
    ...
    crossReferences: JSON.stringify(["Jeremiah 29:13 – You will seek Me and find Me, when you search with all your heart.", "Lamentations 3:22–23 – His mercies are new every morning.", "Psalm 30:5 – Weeping endures for a night, but joy comes in the morning.", "Romans 8:28 – All things work together for good to those called by God."]),
    finalThoughts: "What shapes our peace is not being spared exile, but being sustained by the LORD who has already written the end. His thoughts toward us lean toward peace, not calamity.",
  ...
  },
  {
    ...
    explanation: "Paul commands the believer to trade anxiety for prayer. 'Be anxious for nothing' is a command, not a suggestion — worry is treated as something the believer is to refuse. The alternative is not passivity but prayer: 'in everything by prayer and supplication' — in every circumstance, not just the crises. The phrase 'with thanksgiving' protects the heart from grumbling even while asking. The goal is not that every request is granted but that every need is made known to God, who hears. This verse turns worry into worship by making prayer the reflex of the anxious heart.",
    application: "The next time worry rises, convert it into a specific prayer with thanksgiving. Name the need, thank God, and let His peace take its place.",
    verseIntroduction: "Philippians 4:6 gives the believer a weapon against anxiety: prayer that hands every concern to God with thanksgiving in its hand.",
    backgroundAuthor: "Paul wrote this letter from prison, yet it overflows with joy — proof that the peace he describes is real and possible.",
    backgroundBook: "Philippians is the epistle of joy in Christ, showing how union with Him transforms even the hardest circumstances.",
    backgroundContext: "This verse precedes the promise of God's peace and follows Paul's call to rejoice always; it sits in a passage about contentment and the mind of Christ.",
    wordStudies: JSON.stringify([
    ...
    crossReferences: JSON.stringify(["Philippians 4:7 – The peace of God, which surpasses all understanding, will guard your hearts.", "Matthew 6:25–34 – Do not worry about tomorrow.", "1 Peter 5:7 – Cast all your care upon Him, for He cares for you.", "Psalm 55:22 – Cast your burden on the LORD, and He shall sustain you."]),
    finalThoughts: "Worry and prayer cannot occupy the same heart for long. The believer who learns to pray in everything has found the doorway out of anxiety.",
    takeaways: JSON.stringify(["Anxiety is to be refused, not entertained.", "Everything is a candidate for prayer — nothing is too small.", "Thanksgiving keeps asking humble and hope alive."]),
  },
  {
    ...
    backgroundAuthor: "The apostle John wrote his Gospel so that readers might believe Jesus is the Christ, the Son of God, and have life in His name.",
    backgroundBook: "The Gospel of John is built around life: Jesus is the Life, the Light, and the Resurrection, and belief in Him issues in abundant life.",
    backgroundContext: "This verse sits inside the Good Shepherd discourse, spoken after healing a man born blind and confronting the religious leaders who were harming the flock.",
    wordStudies: JSON.stringify([
    ...
    keyThemes: JSON.stringify(["The thief vs. the Shepherd", "Abundant life in Christ", "The purpose of the coming of Jesus", "Protection and provision for the flock"]),
    crossReferences: JSON.stringify(["John 10:11 – The good Shepherd gives His life for the sheep.", "Psalm 23:1 – The LORD is my shepherd; I shall not want.", "John 14:6 – I am the way, the truth, and the life.", "Colossians 2:9–10 – In Him dwells all fullness; you are complete in Him."]),
    finalThoughts: "The enemy's signature is subtraction; the Shepherd's signature is abundance. Where Jesus rules, life does not merely continue — it overflows.",
    takeaways: JSON.stringify(["Jesus came to give life, not to take it.", "Abundant life is found in the Shepherd, not in the thief's promises.", "Test every influence by whether it brings life or takes it."]),
  },
  {
    ...
    explanation: "This closing verse of Psalm 19 turns worship into a prayer. Having celebrated God's glory in creation and in His word, David now prays about the two things that most reveal a person: the words of the mouth and the meditation of the heart. He asks that both be 'acceptable' — delightful, pleasing — in God's sight. The word for meditation covers the quiet, repeated musings of the inner life, not just outward speech. David ends by confessing who God is to him personally: 'my strength and my Redeemer' — the Rock on whom he stands and the One who sets him free.",
    application: "Before you speak today, pause and ask: are these words acceptable to God? Let the prayer of this verse govern both your speech and your hidden thoughts.",
    verseIntroduction: "Psalm 19:14 is the worshiper's daily surrender: that every word spoken and every thought cherished would find its home in the presence of God.",
    backgroundAuthor: "David, Israel's shepherd-king and psalmist, wrote from the deep well of personal experience with God, both as a warrior and a worshiper.",
    backgroundBook: "The Psalms give language to the whole range of the believer's life — praise, lament, confession, and surrender — before the living God.",
    backgroundContext: "This verse closes a psalm that moves from God's glory in the heavens to His perfection in the law, ending in the psalmist's own need for cleansing and acceptance.",
    wordStudies: JSON.stringify([
    ...
    crossReferences: JSON.stringify(["Psalm 51:15 – O Lord, open my lips, and my mouth shall show forth Your praise.", "Psalm 141:3 – Set a guard, O LORD, over my mouth.", "Matthew 12:34 – Out of the abundance of the heart the mouth speaks.", "Colossians 3:16 – Let the word of Christ dwell in you richly."]),
    finalThoughts: "True worship is not only sung but spoken and thought. The heart that offers its words and meditations to God has learned the secret of an acceptable life.",
  ...
  },
  {
    ...
    explanation: "Peter invites the believer to a radical transfer of anxiety. The word 'casting' pictures throwing or hurling a burden onto someone else — a deliberate, decisive action, not a gradual letting go. 'All your care' leaves nothing out: every worry about provision, relationships, health, and the future. The ground for this command is not the size of our faith but the character of God: 'for He cares for you.' The verb speaks of active, personal concern — God is not a distant administrator of the universe but a Father who is genuinely, presently interested in each of His children's burdens.",
    application: "Take the worry you have been carrying and deliberately hand it to God in prayer. Do it once, and keep doing it — He cares for you personally.",
    verseIntroduction: "1 Peter 5:7 turns anxiety into an act of worship: the believer throws every care onto a God who is personally, actively concerned for them.",
    backgroundAuthor: "Peter, the apostle who had himself known fear and failure, writes to strengthen believers scattered across Asia Minor under pressure.",
    backgroundBook: "First Peter is a letter of hope and holiness for believers facing suffering, calling them to entrust themselves to a faithful Creator.",
    backgroundContext: "These words close a section on humility and watchfulness: having urged believers to cast their anxiety on God, Peter reminds them why it is safe to do so.",
    wordStudies: JSON.stringify([
    ...
    keyThemes: JSON.stringify(["The transfer of anxiety to God", "The personal care of the Father", "Humility and dependence", "Freedom from the weight of worry"]),
    crossReferences: JSON.stringify(["Psalm 55:22 – Cast your burden on the LORD, and He shall sustain you.", "Matthew 6:25–34 – Do not worry about your life; your Father knows your needs.", "Philippians 4:6–7 – In everything by prayer let your requests be made known to God.", "Psalm 37:5 – Commit your way to the LORD; trust also in Him."]),
    finalThoughts: "The size of the burden matters less than the strength of the One who carries it. Because God cares for you, no care is too heavy to give Him.",
  ...
  },
  {
    ...
    backgroundAuthor: "Traditionally attributed to Moses or David, this psalm reflects a life that had learned to shelter under God through wilderness and war.",
    backgroundBook: "The Psalms are the hymnbook and prayer book of God's people, giving voice to trust in God's protection across every season.",
    backgroundContext: "This psalm stands as a song of confidence for the people of God, promising His shelter to those who make Him their refuge.",
    wordStudies: JSON.stringify([
    ...
    crossReferences: JSON.stringify(["Psalm 27:5 – He shall hide me in His pavilion; in the secret place of His tabernacle.", "Psalm 32:7 – You are my hiding place.", "Psalm 121:5 – The LORD is your keeper; the LORD is your shade at your right hand.", "Isaiah 4:6 – A tabernacle for a shadow in the daytime from the heat."]),
    finalThoughts: "Security is found not in a place without storms but in a Presence within the storm. The soul that dwells with God abides under His shadow.",
    takeaways: JSON.stringify(["The secret place is a lifestyle, not a location.", "God's shelter is available to all who make Him home.", "The Most High is also the Almighty — above all and able for all."]),
  },
  {
    ...
    explanation: "This verse states the heart of the gospel with unmatched precision. Salvation is 'by grace' — the undeserved, unearned favor of God as the source — and 'through faith' — trust in Christ as the channel by which that grace is received. Paul immediately guards against two misunderstandings: 'that not of yourselves' rules out human merit, and 'it is the gift of God' rules out boasting. Nothing in the believer's past, present, or future performance contributes to the ground of salvation. The grammar even makes the whole package — salvation and the faith that receives it — a gift, so that no one can claim any credit before God.",
    application: "Stop measuring your standing with God by your performance. Salvation is a finished gift — receive it, rest in it, and let gratitude replace striving.",
    verseIntroduction: "Ephesians 2:8 is the clearest single sentence on how a person is saved: entirely by God's grace, received through faith, and never by human effort.",
    backgroundAuthor: "Paul wrote Ephesians while in prison, unfolding the eternal purposes of God and the believer's standing in Christ.",
    backgroundBook: "Ephesians moves from the riches of grace in Christ to the practical walk that flows from that grace, all rooted in union with Christ.",
    backgroundContext: "These words follow Paul's description of humanity's spiritual death and God's mercy, and they precede his reminder that we are created for good works.",
    wordStudies: JSON.stringify([
    ...
    crossReferences: JSON.stringify(["Romans 3:23–24 – All have sinned and are justified freely by His grace.", "Titus 3:5 – Not by works of righteousness which we have done, but according to His mercy He saved us.", "2 Timothy 1:9 – Saved us and called us with a holy calling, not according to our works.", "Romans 11:6 – If by grace, then it is no longer of works."]),
    finalThoughts: "The gospel does not ask you to become good enough to be saved; it announces that in Christ you already are. Grace is the gift that keeps giving.",
    takeaways: JSON.stringify(["Salvation is by grace, through faith, and not by works.", "The entire gift is from God — including the faith to receive it.", "Grace removes boasting and replaces it with gratitude."]),
  },
  {
    ...
    backgroundAuthor: "This psalm, likely sung at the temple as pilgrims approached, celebrates deliverance and the goodness of the LORD toward His people.",
    backgroundBook: "The Psalms form the worship book of Israel, and Psalm 118 is a song of thanksgiving for salvation that the church has sung for centuries.",
    backgroundContext: "The verse follows the imagery of the stone the builders rejected and precedes the festal procession; the church has long read it as pointing to resurrection day.",
    wordStudies: JSON.stringify([
    ...
    crossReferences: JSON.stringify(["Psalm 118:23 – This was the LORD's doing; it is marvelous in our eyes.", "Lamentations 3:22–23 – His mercies are new every morning.", "Matthew 6:34 – Do not worry about tomorrow; each day has enough trouble of its own.", "Philippians 4:4 – Rejoice in the Lord always; again I will say, rejoice!"]),
    finalThoughts: "Joy is not the reward of a good day but the decision of a God-fearing heart. When the day is received from the LORD, gladness finds its reason.",
    takeaways: JSON.stringify(["Every day is made and given by God.", "Gladness is a choice before it is a feeling.", "The day God makes is worth rejoicing in — whatever it holds."]),
  },
  {
    ...
    explanation: "Hebrews 11 gives faith its most famous definition. 'Substance' (hypostasis) means that which stands under — the foundation, the reality, the title-deed of what is hoped for. Faith treats the promises of God as real enough to build a life on, even before they are seen. 'Evidence' (elenchos) carries the idea of a proof or conviction — the inner certainty that gives assurance to things unseen. Faith is not a leap into the dark but a confident response to the God who has spoken. It is the bridge between promise and fulfillment, and it is how the people of God have always lived.",
    application: "Let faith be the ground under your hope today. Act on what God has promised even before you see it — that is the substance of things hoped for.",
    verseIntroduction: "Hebrews 11:1 is the lens through which all of Scripture's heroes are viewed: faith is the substance of hope and the evidence of the unseen.",
    backgroundAuthor: "The author of Hebrews, writing to Jewish believers under pressure, urges them to hold fast their confession and live by faith.",
    backgroundBook: "Hebrews presents Christ as the fulfillment of all that came before, and chapter 11 as the hall of faith that inspires endurance.",
    backgroundContext: "This definition opens the great chapter of faith, which traces God's people from Abel to the prophets, all living on the substance of things not seen.",
    wordStudies: JSON.stringify([
    ...
    keyThemes: JSON.stringify(["Faith as substance and evidence", "Living by the unseen realities of God", "Hope anchored in promise", "The faithfulness of God's people through history"]),
    crossReferences: JSON.stringify(["Hebrews 11:6 – Without faith it is impossible to please Him.", "2 Corinthians 5:7 – We walk by faith, not by sight.", "Romans 8:24–25 – Hope that is seen is not hope; we wait for it with patience.", "James 2:17 – Faith without works is dead."]),
    finalThoughts: "Faith does not make the unseen visible; it makes the unseen reliable. The believer builds on the substance of God's promises and walks by their evidence.",
  ...
  },
  {
    ...
    explanation: "This short verse explains the origin of all genuine love for God. Our love does not begin with us; it is a response — the echo of a love that started in God. 'He first loved us' reaches back to the cross and to the eternal purpose of God, who loved us while we were still sinners. The grammar makes the priority unmistakable: God's love is the cause, our love is the effect. This truth frees us from trying to manufacture love for God out of our own strength. We love because we have first been loved, and the love we have received becomes the source of the love we give.",
    application: "When your love for God feels cold, do not try to work it up — return to the cross and receive His love for you. Loved people learn to love.",
    verseIntroduction: "1 John 4:19 is the heartbeat of the gospel's effect on us: every genuine love for God is the response to a love that began with Him.",
    backgroundAuthor: "The apostle John, known as the disciple whom Jesus loved, writes to deepen the believers' assurance and love.",
    backgroundBook: "First John is a letter about fellowship with God, built on the twin pillars of truth and love, with assurance as its goal.",
    backgroundContext: "This verse concludes a passage on love as the evidence of knowing God, following John's declaration that God is love.",
    wordStudies: JSON.stringify([
    ...
    keyThemes: JSON.stringify(["God's initiating love", "Love as response to grace", "Assurance rooted in being loved", "Love for others flowing from love received"]),
    crossReferences: JSON.stringify(["John 3:16 – God so loved the world that He gave His only begotten Son.", "Romans 5:8 – God demonstrates His own love toward us, in that while we were still sinners, Christ died for us.", "1 John 4:10 – In this is love, not that we loved God, but that He loved us.", "Ephesians 2:4–5 – God, who is rich in mercy, because of His great love with which He loved us."]),
    finalThoughts: "Love for God is not a ladder we climb to reach Him; it is the echo of a love that reached us first. The heart that knows it is loved begins to love.",
  ...
  },
  {
    ...
    explanation: "Paul announces the radical result of being united to Christ: a new creation. The word 'if' is not doubtful but conditional — the condition is being 'in Christ,' the sphere of salvation. The consequence is nothing less than new creation, the same word used of God's original act of making the world. In Christ, the believer does not merely improve or reform; something genuinely new begins. 'Old things have passed away' describes the old life of sin, guilt, and bondage — its dominion is broken. 'All things have become new' points to new identity, new desires, new destiny, and new power. Conversion is not renovation; it is new creation.",
    application: "Stop defining yourself by who you used to be. In Christ you are a new creation — live today out of your new identity, not your old history.",
    verseIntroduction: "2 Corinthians 5:17 is the believer's new birth certificate: union with Christ means new creation, with the old life passed away and all things made new.",
    backgroundAuthor: "Paul wrote 2 Corinthians to defend his apostolic ministry and to call the Corinthians to the reconciling life of the gospel.",
    backgroundBook: "Second Corinthians is deeply personal, showing Paul's own life as a demonstration of new-creation power in weakness.",
    backgroundContext: "This verse follows Paul's statement that Christ died for all so that those who live might live for Him — the death of the old self and the rise of the new.",
    wordStudies: JSON.stringify([
    ...
    crossReferences: JSON.stringify(["Romans 6:4 – We should walk in newness of life.", "Galatians 6:15 – Neither circumcision nor uncircumcision avails anything, but a new creation.", "Ephesians 4:22–24 – Put off the old man and put on the new man.", "John 3:3 – Unless one is born again, he cannot see the kingdom of God."]),
    finalThoughts: "The gospel does not make bad people good; it makes dead people alive. In Christ, the believer is not repaired but recreated.",
    takeaways: JSON.stringify(["Being in Christ makes you a new creation.", "The old life has passed away in its dominion.", "New identity calls for new living."]),
  },
  {
    ...
    explanation: "This beloved verse pictures the Word of God as light for the journey of life. A 'lamp to my feet' speaks of immediate, step-by-step guidance — enough light for the next step without revealing the whole road. A 'light to my path' speaks of the general direction and course of life, illuminated so that the way ahead is walkable. Together they promise that Scripture provides both present guidance and enduring direction. The imagery is pastoral and practical: the traveler does not need to see the entire journey, only the path one step at a time, and that is exactly what God's word supplies.",
    application: "When you cannot see the whole road, take the next step by the light of God's word. Let Scripture guide both this step and your overall direction.",
    verseIntroduction: "Psalm 119:105 promises that Scripture is sufficient light: a lamp for the immediate step and a light for the whole path of life.",
    backgroundAuthor: "This psalm, the longest in the Psalter, is a sustained meditation on the glory and sufficiency of God's word.",
    backgroundBook: "Psalm 119 celebrates the word of God in all its aspects — statutes, precepts, testimonies, and commands — as the delight of the godly.",
    backgroundContext: "This verse sits in a psalm written by one who had suffered affliction and persecution, discovering that God's word held him steady through the dark.",
    wordStudies: JSON.stringify([
    ...
    crossReferences: JSON.stringify(["Proverbs 6:23 – The commandment is a lamp, and the law a light.", "Psalm 119:130 – The entrance of Your words gives light.", "2 Peter 1:19 – A lamp shining in a dark place, until the day dawns.", "John 8:12 – I am the light of the world; he who follows Me shall not walk in darkness."]),
    finalThoughts: "God does not always show the whole road, but He always shows the next step. His word is enough light for every traveler who will walk by it.",
    takeaways: JSON.stringify(["God's word lights both the step and the path.", "You do not need to see the whole journey, only the next step.", "Scripture is sufficient guidance for the believer's walk."]),
  },
  {
    ...
    explanation: "Isaiah promises strength to those who wait on the LORD. 'Waiting' is not passive idleness but active, expectant trust — the posture of a servant watching for the master's word. The promise is graduated and practical: soaring like eagles (vision and lift), running without weariness (service and effort), and walking without fainting (the long, ordinary road of daily obedience). Each image answers a different season of life. The source of this strength is not human resolve but exchange — the LORD renews the strength of those who trust in Him, trading our weakness for His sufficiency.",
    application: "If today feels heavy, stop striving and wait on the LORD. Expectant trust is not idleness — it is the posture from which renewed strength comes.",
    verseIntroduction: "Isaiah 40:31 is the promise of exchanged strength: those who wait on the LORD receive His power for soaring, running, and walking.",
    backgroundAuthor: "Isaiah, the prophet of judgment and hope, ministered in Judah for decades, calling the people to trust in the holy God of Israel.",
    backgroundBook: "The Book of Isaiah announces both coming judgment and glorious restoration, climaxing in the servant who would bear the sins of many.",
    backgroundContext: "This verse closes a passage of comfort to weary Israel, contrasting human weakness with the everlasting strength of the Creator.",
    wordStudies: JSON.stringify([
    ...
    crossReferences: JSON.stringify(["Psalm 27:14 – Wait on the LORD; be of good courage, and He shall strengthen your heart.", "Psalm 103:5 – Your youth is renewed like the eagle's.", "Lamentations 3:25 – The LORD is good to those who wait for Him.", "2 Corinthians 4:16 – Though our outward man perishes, the inward man is renewed day by day."]),
    finalThoughts: "Strength is not found in hurrying but in waiting. Those who trust the LORD receive His power for every season — the flight, the race, and the long walk.",
    takeaways: JSON.stringify(["Waiting on the LORD is active trust, not idle passivity.", "God renews the strength of those who wait for Him.", "His strength covers soaring, running, and walking seasons."]),
  },
  {
    ...
    explanation: "As Joshua prepares to lead Israel into the Promised Land, God speaks words of commission and courage. The command to 'be strong and of good courage' is repeated because the task ahead is daunting: a new leader, a hostile land, and a nation to guide. Yet the ground of courage is not Joshua's ability but God's presence: 'the LORD your God is with you wherever you go.' The promise is unlimited in scope — not merely at the altar or in the camp, but wherever obedience takes him. Courage, in this verse, is not the absence of fear but the refusal to be ruled by it, because the presence of God is the decisive reality.",
    application: "Name what makes you afraid today, then set against it the promise: the LORD your God is with you wherever you go. Courage follows His presence.",
    verseIntroduction: "Joshua 1:9 is God's commission to every successor and every step of faith: be strong and courageous, because His presence goes with you.",
    backgroundAuthor: "Joshua, Moses' successor, led Israel into the Promised Land; the book bearing his name records the conquest and settlement of Canaan.",
    backgroundBook: "The Book of Joshua shows God fulfilling His promises to Abraham as He gives Israel the land, calling them to obedience and courage.",
    backgroundContext: "God speaks these words to Joshua at the border of the land, as he assumes leadership after Moses' death, facing the Jordan and the walled city of Jericho.",
    wordStudies: JSON.stringify([
    ...
    keyThemes: JSON.stringify(["The command to courage", "God's presence as the ground of strength", "Leadership in faith", "Fear displaced by the presence of God"]),
    crossReferences: JSON.stringify(["Deuteronomy 31:6 – Be strong and of good courage; the LORD your God goes with you.", "Deuteronomy 31:8 – The LORD Himself goes before you; He will not leave you nor forsake you.", "Isaiah 41:10 – Fear not, for I am with you; be not dismayed, for I am your God.", "Matthew 28:20 – I am with you always, even to the end of the age."]),
    finalThoughts: "Courage is not a feeling we manufacture; it is the settled confidence that comes from knowing who walks beside us. Where God's presence goes, fear must yield.",
    takeaways: JSON.stringify(["God commands strength and courage — and supplies the presence that makes them possible.", "Fear is displaced by the certainty of God with us.", "Obedience is the path where His presence is promised."]),
  },
  {
    ...
    explanation: "In the midst of chaos — nations raging, kingdoms tottering — God speaks one word: 'Be still, and know that I am God.' The call to stillness is not an invitation to inactivity but a summons to cease striving, to stop trusting in our own frantic efforts, and to acknowledge who God is. The knowledge is not merely intellectual but relational and experiential: to know that He is God is to entrust oneself to His sovereign rule. The exaltation of God among the nations and in the earth is His declared purpose, and it will not fail. Stillness before God is the posture of faith in the storm.",
    application: "When the world feels loud and your soul feels frantic, obey the command: be still. Stop striving long enough to know that He is God — and that His purposes will stand.",
    verseIntroduction: "Psalm 46:10 is God's quiet command in the chaos: stop striving, know that He is God, and watch His purposes prevail.",
    backgroundAuthor: "This psalm, attributed to the sons of Korah, was sung by the people of God in seasons of threat and upheaval.",
    backgroundBook: "The Psalms give voice to trust in God as refuge and strength, a very present help in trouble.",
    backgroundContext: "Written against a backdrop of war and shaking nations, the psalm declares that God is the city's refuge and that He will be exalted over all.",
    wordStudies: JSON.stringify([
    ...
    keyThemes: JSON.stringify(["Stillness before God", "God's sovereign rule over the nations", "Trust that ceases striving", "The exaltation of God's name"]),
    crossReferences: JSON.stringify(["Psalm 46:1 – God is our refuge and strength, a very present help in trouble.", "Psalm 37:7 – Rest in the LORD, and wait patiently for Him.", "Exodus 14:14 – The LORD will fight for you, and you shall hold your peace.", "Isaiah 2:11 – The LORD alone shall be exalted in that day."]),
    finalThoughts: "The storm does not determine who God is; His exaltation does. The soul that is still before Him has found the unshakable center of the universe.",
  ...
  },
  {
    ...
    explanation: "Jesus extends an open invitation to the weary. 'All you who labor and are heavy laden' describes those burdened by the demands of life and the weight of religious striving — every person who has discovered that human effort cannot produce peace. The command is simple: 'Come to Me.' Rest is not a technique Jesus teaches but a person Jesus gives — He Himself is the rest. The promise 'I will give you rest' is present and personal: not rest after the journey, but rest in the coming to Him. This verse announces the end of self-salvation and the beginning of grace for the exhausted.",
    application: "Bring your exhaustion to Jesus today — not your achievements, your burdens. Come to Him as you are, and receive the rest He gives.",
    verseIntroduction: "Matthew 11:28 is the open door of the gospel: every weary, burdened soul is invited to come to Jesus and find rest.",
    backgroundAuthor: "Matthew, the tax collector turned apostle, wrote his Gospel to show that Jesus is the promised Messiah and King.",
    backgroundBook: "The Gospel of Matthew presents Jesus as the fulfillment of the Old Testament, the King who invites the weary into His kingdom of rest.",
    backgroundContext: "Jesus speaks these words after pronouncing woe on unrepentant cities, contrasting their rejection with the open welcome He offers to the burdened.",
    wordStudies: JSON.stringify([
    ...
    crossReferences: JSON.stringify(["Matthew 11:29–30 – Take My yoke upon you and learn from Me; My yoke is easy and My burden is light.", "John 7:37 – If anyone thirsts, let him come to Me and drink.", "Psalm 55:22 – Cast your burden on the LORD, and He shall sustain you.", "Hebrews 4:9–10 – There remains a rest for the people of God."]),
    finalThoughts: "Rest is not the reward of the finished but the gift to the weary. Jesus does not ask you to fix your life before you come — He asks you to come, and He gives rest.",
    takeaways: JSON.stringify(["Jesus invites the weary and burdened to come to Him.", "Rest is given by Jesus, not earned by effort.", "Your burdens qualify you for His invitation."]),
  },
  {
    ...
    explanation: "Psalm 136 is built on a repeated refrain: 'for His mercy endures forever.' Each line of history — creation, deliverance from Egypt, guidance through the wilderness, and the giving of the land — is answered with the same unchanging chorus. Verse 26 closes the psalm by directing thanksgiving to 'the God of heaven,' the sovereign Ruler of all. The point is cumulative: because God's mercy is eternal, every act of His power becomes an occasion for gratitude. The repetition is not monotonous but deliberate — the heart that needs to hear it again and again is the heart that is learning to trust.",
    application: "Walk through your history the way the psalmist walks through Israel's: line by line, giving thanks that God's mercy endures forever in every chapter.",
    verseIntroduction: "Psalm 136:26 gathers the whole story of God's faithfulness into one refrain — His mercy never runs out, so thanksgiving never runs dry.",
    backgroundAuthor: "This psalm, likely used in temple worship, was sung responsively with the congregation answering the refrain.",
    backgroundBook: "The Psalms give voice to the corporate memory of God's people, rehearsing His mighty acts so that faith is passed from generation to generation.",
    backgroundContext: "The final verse crowns a psalm of remembrance that recounts creation and redemption, ending where it began — in praise of enduring mercy.",
    wordStudies: JSON.stringify([
    ...
    keyThemes: JSON.stringify(["The eternal mercy of God", "Thanksgiving as worship", "Remembering God's mighty acts", "God's sovereignty over heaven and earth"]),
    crossReferences: JSON.stringify(["Psalm 107:1 – Oh, give thanks to the LORD, for He is good! For His mercy endures forever.", "Psalm 118:1 – Give thanks to the LORD, for He is good! For His mercy endures forever.", "Lamentations 3:22 – His compassions fail not; they are new every morning.", "1 Chronicles 16:34 – Give thanks to the LORD, for He is good; for His mercy endures forever."]),
    finalThoughts: "Mercy that endures forever means there is no day, no failure, and no season beyond the reach of God's faithful love. That is reason enough for endless thanks.",
  ...
  },
  {
    ...
    explanation: "This verse promises that the heart that delights in God will receive its desires — but the order is everything. 'Delight yourself in the LORD' means finding one's joy, satisfaction, and pleasure in God Himself, not merely in His gifts. As the heart's center shifts from self to God, its desires are transformed: what we want begins to align with what God wants. The promise is not that God becomes a genie for our every whim, but that He shapes the desires of those who delight in Him, and then grants the desires He has formed. The verse teaches that the deepest joy and the surest fulfillment are both found in the same place: God Himself.",
    application: "Do not run after your desires first — run after God. Delight in Him, and watch your wants be shaped and satisfied by His hand.",
    verseIntroduction: "Psalm 37:4 puts the order of blessing in place: delight in God first, and He Himself becomes both the source and the satisfaction of your desires.",
    backgroundAuthor: "David, writing in his later years, instructs the godly in the patient, trust-filled way of the righteous amid the prosperity of the wicked.",
    backgroundBook: "Psalm 37 is an acrostic wisdom psalm contrasting the way of the righteous with the way of the wicked, urging trust and delight in the LORD.",
    backgroundContext: "This verse sits among encouragements to trust and do good, committing one's way to the LORD and resting in Him rather than fretting over evildoers.",
    wordStudies: JSON.stringify([
    ...
    crossReferences: JSON.stringify(["Psalm 37:5 – Commit your way to the LORD; trust also in Him.", "Psalm 16:11 – In Your presence is fullness of joy; at Your right hand are pleasures forevermore.", "Matthew 6:33 – Seek first the kingdom of God and His righteousness.", "Psalm 145:19 – He will fulfill the desire of those who fear Him."]),
    finalThoughts: "Delight and desire belong together — but delight comes first. The heart that finds its joy in God discovers that its deepest longings were made for Him all along.",
    takeaways: JSON.stringify(["Delight in God is the path to fulfilled desire.", "God transforms the desires of those who delight in Him.", "Joy in God is the deepest satisfaction there is."]),
  },
  {
    ...
    explanation: "Paul's rhetorical question is the hinge of the greatest assurance passage in Scripture. 'These things' refers to all that precedes — election, calling, justification, and the certainty of God's purpose. The condition 'if God is for us' is not hypothetical; for believers it is the settled reality of the gospel. If the Creator and Judge of all is on our side, then no opposing force — human, spiritual, or circumstantial — can ultimately prevail against us. The question is not claiming that opposition does not exist, but that opposition cannot win. It is the confidence of the justified: the One who justifies is the One who is for us.",
    application: "When opposition feels overwhelming, rehearse the question: if God is for me, who can be against me? Measure every enemy against the greatness of your Advocate.",
    verseIntroduction: "Romans 8:31 is the confidence of the believer: with God on our side, no adversary and no accusation can ultimately stand against us.",
    backgroundAuthor: "Paul wrote Romans to set forth the gospel of God and the glorious security of all who are in Christ Jesus.",
    backgroundBook: "Romans unfolds justification by faith and its consequences, climaxing in the unbreakable chain of God's love in chapter 8.",
    backgroundContext: "This verse begins the concluding celebration of the chapter, moving from God's sovereign purposes to the believer's unshakeable security in Christ.",
    wordStudies: JSON.stringify([
    ...
    crossReferences: JSON.stringify(["Romans 8:32 – He who did not spare His own Son, how shall He not with Him freely give us all things?", "Romans 8:33–34 – Who shall bring a charge against God's elect? It is God who justifies.", "Psalm 118:6 – The LORD is on my side; I will not fear. What can man do to me?", "Isaiah 41:10 – Fear not, for I am with you; I will strengthen you."]),
    finalThoughts: "The outcome of every battle is decided by which side God is on — and in Christ, He is decisively for us. That settles the question before it is asked.",
    takeaways: JSON.stringify(["God's being for us outweighs every adversary.", "This assurance is grounded in the gospel, not in feelings.", "With God on our side, we can face anything."]),
  },
  {
    ...
    explanation: "David opens this psalm with a confession of confidence that banishes fear. 'The LORD is my light' — He illuminates the way and disperses darkness; 'my salvation' — He delivers from every enemy; 'the strength of my life' — He is the fortress of my very existence. Each title of God becomes the answer to a question of fear: 'whom shall I fear?' and 'of whom shall I be afraid?' The questions are not denials that dangers exist but declarations that none can prevail against the One who is our light, salvation, and strength. Fear loses its power when the soul is anchored in who God is.",
    application: "Meet every fear today with the titles of God: He is my light, my salvation, the strength of my life. Fear cannot stand against that confession.",
    verseIntroduction: "Psalm 27:1 is the believer's declaration of confidence: with the LORD as light, salvation, and strength, there is nothing left to fear.",
    backgroundAuthor: "David wrote this psalm in a season of threat, expressing the single-hearted desire to dwell in the house of the LORD all his days.",
    backgroundBook: "The Psalms record the prayers and praises of God's people, giving voice to confidence in God's protection amid danger.",
    backgroundContext: "This opening verse frames a psalm of trust sung in the face of enemies, war, and the fear of abandonment — answered by confidence in God's presence.",
    wordStudies: JSON.stringify([
    ...
    crossReferences: JSON.stringify(["Psalm 18:28 – You will light my lamp; the LORD my God will enlighten my darkness.", "Isaiah 12:2 – God is my salvation; I will trust and not be afraid.", "Psalm 28:8 – The LORD is their strength, and He is the saving refuge of His anointed.", "Micah 7:8 – The LORD will be a light to me."]),
    finalThoughts: "Fear asks, 'What could happen?' Faith answers, 'Who is my God?' When the LORD is our light, salvation, and strength, the questions of fear lose their power.",
    takeaways: JSON.stringify(["God's character is the answer to every fear.", "Light, salvation, and strength are found in the LORD.", "The trusting heart has nothing left to be afraid of."]),
  },
  {
    ...
    explanation: "Jesus answers Thomas's question about the way to the Father with one of the great 'I am' sayings. He does not say He knows the way or teaches the way; He says, 'I am the way.' He is the way — the only route to the Father; the truth — the only reliable revelation of God; and the life — the only source of spiritual vitality. The exclusivity is unmistakable: 'No one comes to the Father except through Me.' This is not narrow-mindedness but the logic of the gospel: if Jesus is who He claims to be, then He alone can bridge the distance between sinners and God. The verse is both a claim and an invitation.",
    application: "Stop searching for a way to God through your own efforts. Jesus is the way, the truth, and the life — come to the Father through Him today.",
    verseIntroduction: "John 14:6 is the boldest claim of the gospel: Jesus Himself is the way to the Father, the truth of God, and the life of the world.",
    backgroundAuthor: "The apostle John recorded Jesus' farewell discourse, capturing the intimacy of the last night before the cross.",
    backgroundBook: "The Gospel of John is built on the 'I am' sayings of Jesus, each declaring an aspect of who He is and what He gives.",
    backgroundContext: "Jesus speaks these words in the upper room, comforting His disciples on the night before His death, after telling them He is going to prepare a place.",
    wordStudies: JSON.stringify([
    ...
    crossReferences: JSON.stringify(["John 10:9 – I am the door; if anyone enters by Me, he will be saved.", "Acts 4:12 – There is no other name under heaven given among men by which we must be saved.", "1 Timothy 2:5 – There is one God and one Mediator between God and men, the Man Christ Jesus.", "John 11:25 – I am the resurrection and the life."]),
    finalThoughts: "The way to God is not a path we find but a Person we come to. Jesus does not merely point to the Father — He is the way to Him.",
    takeaways: JSON.stringify(["Jesus is the way to the Father — not one way among many.", "In Him we have the truth about God and the life of God.", "Access to the Father is through Christ alone."]),
  },
];

// Build a lookup map by book|chapter|verse
const verseMap = new Map();
for (const v of verseLibrary) {
  verseMap.set(`${v.bookName}|${v.chapter}|${v.verseNumber}`, v);
}

// Fields that should be enriched (skip bookName/chapter/verseNumber/displayDate)
const RICH_FIELDS = [
...
async function main() {
  ...
  // ── Step 1: Enrich existing verses missing rich fields ──────────────────
  ...
  // ── Step 2: Ensure coverage for today through 21 days out ──────────────
  let created = 0;
  for (let dayOffset = 0; dayOffset <= 21; dayOffset++) {
    ...
    if (existing) continue; // already has a verse for this day

    // Pick the next verse from the library (cycle through)
  ...
  threeWeekEnd.setDate(threeWeekEnd.getDate() + 21);

  const inRange = await prisma.dailyVerse.findMany({
    where: {
      displayDate: { gte: today, lte: threeWeekEnd },
      isPublished: true,
    },
  });

  // Check how many are now fully populated
  const FULL_FIELDS = [
    "explanation", "application", "verseIntroduction",
    "backgroundAuthor", "backgroundBook", "backgroundContext",
    "wordStudies", "practicalApplications", "keyThemes",
  ...
  for (const v of inRange) {
    const hasAll = FULL_FIELDS.every((f) => v[f]);
    if (hasAll) fullCount++;
  }

  console.log(`\n=== Daily Verse Enrichment Complete ===`);
  console.log(`Existing verses enriched: ${enriched}`);
  console.log(`New verses created: ${created}`);
  console.log(`Total in DB: ${finalCount}`);
  console.log(`Published verses in next 3 weeks: ${inRange.length}`);
  console.log(`Fully populated in next 3 weeks: ${fullCount}/${inRange.length}`);
